                    ...
                    if (Cooltime.getOf("king_gold", e.player.uniqueId) == 0) {
                        ...
                        if (Cooltime.getOf("king_gold", e.player.uniqueId) % 1200 / 20 >= 10) {
                            e.player.spigot().sendMessage(
                                ...
                                TextComponent(text("%red%%bold%남은 쿨타임 ${Cooltime.getOf("king_gold", e.player.uniqueId) / 1200} : ${Cooltime.getOf("king_gold", e.player.uniqueId) % 1200 / 20}"))
                            )
                        } else {
                            e.player.spigot().sendMessage(
                                ChatMessageType.ACTION_BAR,
                                TextComponent(text("%red%%bold%남은 쿨타임 ${Cooltime.getOf("king_gold", e.player.uniqueId) / 1200} : 0${Cooltime.getOf("king_gold", e.player.uniqueId) % 1200 / 20}"))
                            )
                        }
                    }
                }
                ...
                if (Cooltime.getOf("o2", e.player.uniqueId) < 600) {
                    ...
                    for (i in 0..29) {
                        plugin.delay (i.toLong()) {
                            ...
                            if (Cooltime.getOf("o2", e.player.uniqueId) % 1200 >= 10) {
                                e.player.spigot().sendMessage(
                                    ChatMessageType.ACTION_BAR,
                                    TextComponent(text("%green%%bold% 산소 보충중 %red%%bold%${Cooltime.getOf("o2", e.player.uniqueId) / 1200} %white%%bold%: %red%%bold%${Cooltime.getOf("o2", e.player.uniqueId) % 1200 / 20}"))
                                )
                            } else {
                                e.player.spigot().sendMessage(
                                    ChatMessageType.ACTION_BAR,
                                    TextComponent(text("%green%%bold% 산소 보충중 %red%%bold%${Cooltime.getOf("o2", e.player.uniqueId) / 1200} %white%%bold%: %red%%bold%0${Cooltime.getOf("o2", e.player.uniqueId) % 1200 / 20}"))
                                )
                            }
                        }
                    }
                    plugin.delay (30) {
                        ...
                        if (Cooltime.getOf("o2", e.player.uniqueId) % 1200 >= 10) {
                            e.player.spigot().sendMessage(
                                ChatMessageType.ACTION_BAR,
                                TextComponent(text("%green%%bold% 산소 보충 완료! %red%%bold%${Cooltime.getOf("o2", e.player.uniqueId) / 1200} %white%%bold%: %red%%bold%${Cooltime.getOf("o2", e.player.uniqueId) % 1200 / 20}"))
                            )
                        } else {
                            e.player.spigot().sendMessage(
                                ChatMessageType.ACTION_BAR,
                                TextComponent(text("%green%%bold% 산소 보충 완료! %red%%bold%${Cooltime.getOf("o2", e.player.uniqueId) / 1200} %white%%bold%: %red%%bold%0${Cooltime.getOf("o2", e.player.uniqueId) % 1200 / 20}"))
                            )
                        }
                        plugin.delay (10) {
